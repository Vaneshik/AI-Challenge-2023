...
class FrontSeptalV1(nn.Module):
	def __init__(self):
		super().__init__()
		self.conv1 = nn.Conv1d(4, 32, kernel_size=5, padding=3)
		...
		self.do2_3 = nn.Dropout2d(p=0.08)
